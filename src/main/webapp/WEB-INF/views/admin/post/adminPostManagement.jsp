    ...
    <div class="d-flex align-items-center justify-content-between mb-2">
        ...
        <div class="d-flex align-items-center">
            ...
            <button type="button" class="btn btn-primary"
                    onclick="location.href='/admin/post/${currentBoard.boardId}/deactivate'">비활성화 목록
            </button>
        </div>
    </div>
    ...
    <nav>
        <ul class="pagination justify-content-center">
            ...
            <c:if test="${postPagination.prev}">
                <li class="page-item">
                    <a class="page-link"
                       href="${pageContext.request.contextPath}/admin/post/${boardId}?page=${pagination.startBlockPage - 1}">&lt;</a>
                </li>
            </c:if>

    ...
    <div class="container" style="max-width: 850px;">
        <form enctype="multipart/form-data" method="post"
            ...
            <div>
                ...
                <input type="radio" id="noticeFlag-Y" name="noticeFlag" value="N"
                ${postDetail.noticeFlag == 'N' ? 'checked' : ''} />

                <label for="noticeFlag-N">공지사항 게시글</label>
                <input type="radio" id="noticeFlag-N" name="noticeFlag" value="Y"
                ${postDetail.noticeFlag == 'Y' ? 'checked' : ''} />
            </div>
            ...
            <a href="/${boardId}/post/detail/${postId}">

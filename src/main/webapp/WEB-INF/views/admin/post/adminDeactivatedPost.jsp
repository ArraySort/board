...
<html lang="kr">
<head>
    <title>Board Admin Management Page | 비활성화 게시글 관리 </title>
        ...
        <div class="page-header">
            <div class="page-block">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="font-size: 1rem">비활성화 게시글 개수
                        : ${deactivatePostPagination.postList.size()}</li>
                </ul>
            </div>
        </div>
        <!-- 게시판 페이지 헤더 끝 -->
        ...
        <div class="row">
            <div class="list-group">
                <c:forEach var="post" items="${deactivatePostPagination.postList}" varStatus="status">
                    ...
                    <div class="list-group-item mb-3 rounded-3 col-9 mx-auto custom-hover"
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <form action="/admin/post/${currentBoard.boardId}/${post.postId}/edit-activate-flag"
                                  method="post">
                                <sec:csrfInput/>
                                <button class="btn btn-sm btn-light-secondary">활성화</button>
                            </form>
                        </div>
                        <!-- 생성일, 수정일, 조회수, 댓글수, 좋아요 -->

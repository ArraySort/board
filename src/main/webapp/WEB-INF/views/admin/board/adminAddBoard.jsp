        ...
        <div class="ms-auto pc-mob-drp">
            <ul class="list-unstyled">
                <li class="pc-h-item d-none d-md-inline-flex">
                    <div class="m-3">
                        <button type="submit" class="btn btn-light-secondary" form="addBoardForm">추가</button>
            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">게시판 추가</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-center">
                            <form method="post"
                                  id="addBoardForm"
                                  action="${pageContext.request.contextPath}/admin/board/process-add-board"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input type="radio" id="imageFlag-Y" name="imageFlag" value="Y"
                                                       class="form-check-input" checked>
                                                <label for="imageFlag-Y" class="form-check-label">허용</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="radio" id="imageFlag-N" name="imageFlag" value="N"

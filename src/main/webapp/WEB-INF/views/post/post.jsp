        ...
        <div class="me-auto pc-mob-drp">
            <ul class="list-unstyled">
                ...
                <li class="pc-h-item d-none d-md-inline-flex">
                    <form class="d-md-inline-flex header-search" method="get" action="/${boardId}/post">
            ...
            <ul class="list-unstyled">
                <li class="pc-h-item d-none d-md-inline-flex">
                    <div class="m-3">
                        ...
                        <c:if test="${isAuthenticatedUser}">
                            <button type="button" class="btn btn-light-secondary"
                                    onclick="location.href='/${boardId}/post/temp'">임시저장 목록
                            </button>
                        </c:if>
                    </div>
                </li>
                    ...
                    <div class="table-active table-responsive table" style="margin-top: 2%">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <c:forEach var="post" items="${pagination.postList}" varStatus="status">
                                ...
                                <tr onclick="location.href='/${boardId}/post/detail/${post.postId}?search=${page.search}&searchType=${page.searchType}&sortType=${page.sortType}&page=${page.page}'">
                                    <td>${postNumber}</td>
                                    <td>
                                        <c:if test="${post.noticeFlag == 'Y'}">[공지사항]</c:if>
                                            ${post.title}
                                    </td>
                                    <c:choose>
        ...
        <div class="row">
            <c:forEach var="post" items="${pagination.postList}" varStatus="status">
                <div class="col-md-6 col-lg-4">
                    <div class="card icon-link-hover border-3 border-white"
                         onclick="location.href='/${boardId}/post/detail/${post.postId}?search=${page.search}&searchType=${page.searchType}&sortType=${page.sortType}&page=${page.page}'">

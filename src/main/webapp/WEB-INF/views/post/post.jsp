            ...
            <div class="row">
                <c:forEach var="post" items="${pagination.postList}" varStatus="status">
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-3 border-white custom-hover"
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><small style="font-size: 0.8rem;">
                                    <i class="ti ti-eye"> ${post.views}</i> | <i
                                        class="ti ti-message-circle"> ${post.commentCount}</i> |
                                    <i class="ti ti-thumb-up"> ${post.likeCount}</i>
                                </small></p>

                                <div class="card-text" style="font-size: 0.8rem;">생성 날짜 :
                                    <fmt:formatDate value="${post.createdAt}" pattern="yyyy-MM-dd HH:mm"/>
                                </div>
                                <div class="card-text" style="font-size: 0.8rem;">수정 날짜 :
